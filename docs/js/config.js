...
window.HACKNET_CONFIG = {
  ...
  filesApiUrl: 'https://studied-speed-machines-argue.trycloudflare.com',
  uploadWorkerUrl: 'https://studied-speed-machines-argue.trycloudflare.com', // alias for filesApiUrl (either works)
