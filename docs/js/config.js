...
window.HACKNET_CONFIG = {
  ...
  filesApiUrl: 'https://reached-country-imperial-cellular.trycloudflare.com',
  uploadWorkerUrl: 'https://reached-country-imperial-cellular.trycloudflare.com', // alias for filesApiUrl (either works)
